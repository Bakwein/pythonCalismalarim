a = """Python programlama dili Guido Van Rossum adlı Hollandalı bir programcı ',
...
yılan figürü ile temsil edilmesi neredeyse bir gelenek ', 'halini almıştırdiyebiliriz."""
print(a.splitlines())
print("")
